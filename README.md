...
## 🔹 About Me  
I am a **Data Engineering and Cyber Security completed graduate** with hands-on experience in **building scalable data pipelines, cloud architectures, and real-time streaming systems**.  
...
Some highlights:  
- Built a **Streamlit app** predicting developer salaries in Europe using **Gradient Boosting**.  
- Implemented **AWS serverless pipelines** using **Glue, Lambda, S3, and Athena** for automated data ingestion.  
- Experienced in **real-time data processing with Kafka and Spark Streaming**.  
- Skilled in **data cleaning, EDA, model building, and visualization**, bridging the gap between raw data and actionable insights.  
...
- **Google Cloud:** BigQuery, Cloud Data Fusion  
- **Data Platforms:** Snowflake, Databricks  
- **Big Data Tools:** Hadoop, Apache Spark, PySpark  
- **Orchestration & ETL:** Apache Airflow, Data Build Tool (DBT)  
...
- Data Gathering, Cleaning, EDA, Model Building  
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/PySpark-2C2D72?style=for-the-badge&logo=python&logoColor=white" />
